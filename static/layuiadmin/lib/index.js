...
function(a) {
    ...
    l = function(a, d) {
        ...
        if (b.each(function(e) {
            ...
            n = i.attr("lay-id");
            n === a && (l = !0, t.index = e)
        }), d = d || "鏂版爣绛鹃〉", e.pageTabs) l || (r(s).append(['<div class="layadmin-tabsbody-item layui-show">', '<iframe src="' + a + '" frameborder="0" class="layadmin-iframe"></iframe>', "</div>"].join("")), t.index = b.length, i.tabAdd(o, {
            title: "<span>" + d + "</span>",
            id: a,
            attr: y
        }));
