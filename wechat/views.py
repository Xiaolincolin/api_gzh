                ...
                if res.status_code == 200:
                    ...
                    if json_data:
                        ...
                        if openid:
                            ...
                            today_sql = "SELECT n.`name`,m.product,m.creative,m.type_id,m.`day` FROM wechat_material as m,wechat_name as n,wechat_related as r where m.wx_id=n.wx_id and n.wx_id=r.wx_id and openid='{openid}' ORDER BY `day` desc;".format(
                                openid=openid)
