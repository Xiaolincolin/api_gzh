                ...
                if res.status_code == 200:
                    ...
                    if json_data:
                        ...
                        if openid:
                            ...
                            today_sql = "SELECT n.`name`,l.product,l.creative,l.type_id,l.day FROM wechat_related as r,wechat_distinct as d,wechat_name as n,wechat_log as l where r.wx_id=d.wx_id and d.statextstr=l.statextstr and r.wx_id=n.wx_id  and openid='{openid}' and `day`>'2020-03-28' ORDER BY `day` desc".format(
                                openid=openid)
